...
void Service::ServicesManager::registerService (unique_ptr<AbstractService> service) {
    services.push_back(std::move(service));
}

Service::AbstractService* Service::ServicesManager::findService (const string& url) const {
...
Service::HttpStatus Service::ServicesManager::queryService (string& out, const string& in, const string& url, const string& method) { 
